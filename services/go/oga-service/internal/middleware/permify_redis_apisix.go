...
// and APISIX admin API integration for oga-service.
//
...
// APISIX:  Registers oga-service routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → oga-service:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "oga-service"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "oga-service"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "oga-service"),
	}
}

// RegisterRoutes registers oga-service routes in APISIX on startup.
