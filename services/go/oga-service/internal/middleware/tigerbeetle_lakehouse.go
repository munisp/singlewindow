...
func NewTigerBeetleClient() *TigerBeetleClient {
	...
	return &TigerBeetleClient{
		...
		logger:     slog.Default().With("component", "tigerbeetle", "service", "oga-service"),
	}
}
...
func NewLakehouseClient() *LakehouseClient {
	...
	return &LakehouseClient{
		...
		logger:     slog.Default().With("component", "lakehouse", "service", "oga-service"),
	}
}
