// temporal_client.go — Temporal workflow engine client for oga-service.
//
...
//
// The oga-service acts as both a Temporal client (starts workflows) and
