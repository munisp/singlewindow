// temporal_client.go — Temporal workflow engine client for audit-service.
//
...
//
// The audit-service acts as both a Temporal client (starts workflows) and
