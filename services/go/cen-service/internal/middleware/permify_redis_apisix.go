...
// and APISIX admin API integration for cen-service.
//
...
// APISIX:  Registers cen-service routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → cen-service:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "cen-service"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "cen-service"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "cen-service"),
	}
}

// RegisterRoutes registers cen-service routes in APISIX on startup.
