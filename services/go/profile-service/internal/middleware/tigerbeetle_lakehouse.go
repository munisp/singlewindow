...
// integration for profile-service.
//
...
func NewTigerBeetleClient() *TigerBeetleClient {
	...
	return &TigerBeetleClient{
		...
		logger:     slog.Default().With("component", "tigerbeetle", "service", "profile-service"),
	}
}
...
func NewLakehouseClient() *LakehouseClient {
	...
	return &LakehouseClient{
		...
		logger:     slog.Default().With("component", "lakehouse", "service", "profile-service"),
	}
}
