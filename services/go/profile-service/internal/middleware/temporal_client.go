// temporal_client.go — Temporal workflow engine client for profile-service.
//
...
//
// The profile-service acts as both a Temporal client (starts workflows) and
...
const (
	TaskQueueAudit       = "profile-service"
