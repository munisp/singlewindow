...
// and APISIX admin API integration for profile-service.
//
...
// APISIX:  Registers profile-service routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → profile-service:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "profile-service"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "profile-service"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "profile-service"),
	}
}

// RegisterRoutes registers profile-service routes in APISIX on startup.
