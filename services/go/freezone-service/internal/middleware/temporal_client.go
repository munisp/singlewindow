// temporal_client.go — Temporal workflow engine client for freezone-service.
//
...
//
// The freezone-service acts as both a Temporal client (starts workflows) and
...
const (
	TaskQueueAudit       = "freezone-service"
