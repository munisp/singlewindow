...
// and APISIX admin API integration for wazuh-svc.
//
...
// APISIX:  Registers wazuh-svc routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → wazuh-svc:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "wazuh-svc"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "wazuh-svc"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "wazuh-svc"),
	}
}

// RegisterRoutes registers wazuh-svc routes in APISIX on startup.
