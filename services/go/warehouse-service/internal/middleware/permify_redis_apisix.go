...
// and APISIX admin API integration for warehouse-service.
//
...
// APISIX:  Registers warehouse-service routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → warehouse-service:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "warehouse-service"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "warehouse-service"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "warehouse-service"),
	}
}

// RegisterRoutes registers warehouse-service routes in APISIX on startup.
