// temporal_client.go — Temporal workflow engine client for warehouse-service.
//
...
//
// The warehouse-service acts as both a Temporal client (starts workflows) and
...
const (
	TaskQueueAudit       = "warehouse-service"
