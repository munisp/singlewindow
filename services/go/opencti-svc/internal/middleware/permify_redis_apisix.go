...
// and APISIX admin API integration for opencti-svc.
//
...
// APISIX:  Registers opencti-svc routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → opencti-svc:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "opencti-svc"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "opencti-svc"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "opencti-svc"),
	}
}

// RegisterRoutes registers opencti-svc routes in APISIX on startup.
