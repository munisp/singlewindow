...
func NewTigerBeetleClient() *TigerBeetleClient {
	...
	return &TigerBeetleClient{
		...
		logger:     slog.Default().With("component", "tigerbeetle", "service", "opencti-svc"),
	}
}
...
func NewLakehouseClient() *LakehouseClient {
	...
	return &LakehouseClient{
		...
		logger:     slog.Default().With("component", "lakehouse", "service", "opencti-svc"),
	}
}
