...
// integration for asean-sw-service.
//
...
func NewTigerBeetleClient() *TigerBeetleClient {
	...
	return &TigerBeetleClient{
		...
		logger:     slog.Default().With("component", "tigerbeetle", "service", "asean-sw-service"),
	}
}
...
func NewLakehouseClient() *LakehouseClient {
	...
	return &LakehouseClient{
		...
		logger:     slog.Default().With("component", "lakehouse", "service", "asean-sw-service"),
	}
}
