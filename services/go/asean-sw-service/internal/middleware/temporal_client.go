// temporal_client.go — Temporal workflow engine client for asean-sw-service.
//
...
//
// The asean-sw-service acts as both a Temporal client (starts workflows) and
...
const (
	TaskQueueAudit       = "asean-sw-service"
