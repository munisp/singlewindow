...
func NewTigerBeetleClient() *TigerBeetleClient {
	...
	return &TigerBeetleClient{
		...
		logger:     slog.Default().With("component", "tigerbeetle", "service", "kubecost-svc"),
	}
}
...
func NewLakehouseClient() *LakehouseClient {
	...
	return &LakehouseClient{
		...
		logger:     slog.Default().With("component", "lakehouse", "service", "kubecost-svc"),
	}
}
