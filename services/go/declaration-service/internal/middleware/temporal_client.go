// temporal_client.go — Temporal workflow engine client for declaration-service.
//
...
//
// The declaration-service acts as both a Temporal client (starts workflows) and
...
const (
	TaskQueueAudit       = "declaration-service"
