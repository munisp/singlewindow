...
// and APISIX admin API integration for declaration-service.
//
...
// APISIX:  Registers declaration-service routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → declaration-service:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "declaration-service"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "declaration-service"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "declaration-service"),
	}
}

// RegisterRoutes registers declaration-service routes in APISIX on startup.
