...
// and APISIX admin API integration for keycloak-svc.
//
...
// APISIX:  Registers keycloak-svc routes via APISIX Admin API on startup.
//          Route: /api/v1/audit/* → keycloak-svc:8090
package middleware
...
func NewPermifyClient() *PermifyClient {
	...
	return &PermifyClient{
		...
		logger:     slog.Default().With("component", "permify", "service", "keycloak-svc"),
	}
}
...
func NewRedisClient() *RedisClient {
	...
	return &RedisClient{
		...
		logger:     slog.Default().With("component", "redis", "service", "keycloak-svc"),
	}
}
...
func NewAPISIXClient() *APISIXClient {
	...
	return &APISIXClient{
		...
		logger:     slog.Default().With("component", "apisix", "service", "keycloak-svc"),
	}
}

// RegisterRoutes registers keycloak-svc routes in APISIX on startup.
