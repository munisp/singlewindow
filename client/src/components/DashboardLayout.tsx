    ...
    return [
      {
        ...
        items: [
          ...
          { icon: Award, label: "AEO Applications", path: "/app/aeo/applications" },
          { icon: UserCheck, label: "Trader Verification", path: "/app/admin/kyc-review" },
          { icon: Users, label: "Stakeholder Registration Review", path: "/app/admin/stakeholder-registrations" },
    ...
    return [
      {
        ...
        items: [
          ...
          ...(role === "customs_officer" ? [{ icon: Users, label: "Stakeholder Registration Review", path: "/app/admin/stakeholder-registrations" }] : []),
          { icon: ClipboardCheck, label: "Post-Clearance Review", path: "/app/customs/audit" },
        ],
      },
      {
  ...
  return [
    {
      ...
      items: [
        ...
        { icon: Anchor, label: "Cargo Tracking Map", path: "/app/geo/cargo-tracking" },
        { icon: UserCheck, label: "Stakeholder Registration", path: "/app/stakeholder-registration" },
        { icon: Users, label: "Mandate Management", path: "/app/mandates" },
