/**
 * TradeGateway™ NGSWTP — React Native Payments Screen
 * Parity with PWA Payments page. Uses trpc.payments.list.useQuery.
 */
...
export default function PaymentsScreen() {
  const { data, isLoading, refetch } = trpc.payments.list.useQuery(undefined, { retry: 2 });
