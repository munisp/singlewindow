/**
 * TradeGateway™ NGSWTP — React Native Cargo Tracking Screen
 * Parity with PWA Cargo Tracking page. Uses trpc.cargoTracking.list.useQuery.
 */
import React from "react";
import { View, Text, ScrollView, ActivityIndicator, StyleSheet, RefreshControl } from "react-native";
import { trpc } from "../../services/trpc";

export default function CargoTrackingScreen() {
  const { data, isLoading, refetch } = trpc.cargoTracking.list.useQuery(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>Cargo Tracking</Text>
      {isLoading ? (
