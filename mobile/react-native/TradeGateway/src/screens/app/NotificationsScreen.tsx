/**
 * TradeGateway™ NGSWTP — React Native Notifications Screen
 * Parity with PWA Notifications page. Uses trpc.userNotifications.list.useQuery.
 */
...
export default function NotificationsScreen() {
  const { data, isLoading, refetch } = trpc.userNotifications.list.useQuery(undefined, { retry: 2 });
