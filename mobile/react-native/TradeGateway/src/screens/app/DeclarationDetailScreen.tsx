/**
 * TradeGateway™ NGSWTP — React Native Declaration Detail Screen
 * Parity with PWA Declaration Detail page. Uses trpc.declarations.getById.useQuery.
 */
...
export default function DeclarationDetailScreen() {
  const { data, isLoading, refetch } = trpc.declarations.getById.useQuery(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>Declaration Detail</Text>
      {isLoading ? (
