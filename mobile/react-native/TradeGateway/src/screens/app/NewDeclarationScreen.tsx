/**
 * TradeGateway™ NGSWTP — React Native New Declaration Screen
 * Parity with PWA New Declaration page. Uses trpc.declarations.create.useMutation.
 */
...
export default function NewDeclarationScreen() {
  const { data, isLoading, refetch } = trpc.declarations.create.useMutation(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>New Declaration</Text>
      {isLoading ? (
