/**
 * TradeGateway™ NGSWTP — React Native Document Vault Screen
 * Parity with PWA Document Vault page. Uses trpc.documentVault.list.useQuery.
 */
...
export default function DocumentVaultScreen() {
  const { data, isLoading, refetch } = trpc.documentVault.list.useQuery(undefined, { retry: 2 });
