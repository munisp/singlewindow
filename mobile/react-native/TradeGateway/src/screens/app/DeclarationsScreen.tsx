/**
 * TradeGateway™ NGSWTP — React Native Declarations List Screen
 * Parity with PWA Declarations List page. Uses trpc.declarations.list.useQuery.
 */
...
export default function DeclarationsScreen() {
  const { data, isLoading, refetch } = trpc.declarations.list.useQuery(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>Declarations List</Text>
      {isLoading ? (
