/**
 * TradeGateway™ NGSWTP — React Native KYC Verification Screen
 * Parity with PWA KYC Verification page. Uses trpc.kyc.getStatus.useQuery.
 */
...
export default function KYCScreen() {
  const { data, isLoading, refetch } = trpc.kyc.getStatus.useQuery(undefined, { retry: 2 });
