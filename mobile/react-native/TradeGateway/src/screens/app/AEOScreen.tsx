/**
 * TradeGateway™ NGSWTP — React Native AEO Programme Screen
 * Parity with PWA AEO Programme page. Uses trpc.aeo.getStatus.useQuery.
 */
import React from "react";
import { View, Text, ScrollView, ActivityIndicator, StyleSheet, RefreshControl } from "react-native";
import { trpc } from "../../services/trpc";

export default function AEOScreen() {
  const { data, isLoading, refetch } = trpc.aeo.getStatus.useQuery(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>AEO Programme</Text>
      {isLoading ? (
