/**
 * TradeGateway™ NGSWTP — React Native My Profile Screen
 * Parity with PWA My Profile page. Uses trpc.profiles.getMyProfile.useQuery.
 */
...
export default function ProfileScreen() {
  const { data, isLoading, refetch } = trpc.profiles.getMyProfile.useQuery(undefined, { retry: 2 });
