/**
 * TradeGateway™ NGSWTP — React Native Scan Document Screen
 * Parity with PWA Scan Document page. Uses trpc.vision.analyzeDocument.useMutation.
 */
...
export default function ScanDocumentScreen() {
  const { data, isLoading, refetch } = trpc.vision.analyzeDocument.useMutation(undefined, { retry: 2 });
