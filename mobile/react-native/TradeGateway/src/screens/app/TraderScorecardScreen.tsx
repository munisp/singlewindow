/**
 * TradeGateway™ NGSWTP — React Native Trader Scorecard Screen
 * Parity with PWA Trader Scorecard page. Uses trpc.traderScorecard.getScorecard.useQuery.
 */
import React from "react";
import { View, Text, ScrollView, ActivityIndicator, StyleSheet, RefreshControl } from "react-native";
import { trpc } from "../../services/trpc";

export default function TraderScorecardScreen() {
  const { data, isLoading, refetch } = trpc.traderScorecard.getScorecard.useQuery(undefined, { retry: 2 });
  ...
  return (
    ...
    >
      <Text style={styles.title}>Trader Scorecard</Text>
      {isLoading ? (
