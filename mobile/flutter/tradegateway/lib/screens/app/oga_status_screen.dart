/// TradeGateway™ NGSWTP — Flutter OGA Status Screen
library;
...
class _OGAStatusScreenState extends State<OGAStatusScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for OGA Status
      // final data = await ApiService().getOGAStatus();
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("OGA Status", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
