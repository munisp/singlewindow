/// TradeGateway™ NGSWTP — Flutter Declaration Detail Screen
library;
...
class DeclarationDetailScreen extends StatefulWidget {
  final int id;
  const DeclarationDetailScreen({super.key, required this.id});
  @override
...
class _DeclarationDetailScreenState extends State<DeclarationDetailScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for Declaration Detail
      // final data = await ApiService().getDeclarationDetail();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Declaration Detail", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
        backgroundColor: const Color(0xFF0A1628),
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("Declaration Detail", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
