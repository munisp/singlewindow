/// TradeGateway™ NGSWTP — Flutter My Profile Screen
library;
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for My Profile
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("My Profile", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
