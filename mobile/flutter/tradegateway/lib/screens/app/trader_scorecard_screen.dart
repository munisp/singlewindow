/// TradeGateway™ NGSWTP — Flutter Trader Scorecard Screen
library;
...
class _TraderScorecardScreenState extends State<TraderScorecardScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for Trader Scorecard
      // final data = await ApiService().getTraderScorecard();
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("Trader Scorecard", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
