/// TradeGateway™ NGSWTP — Flutter AEO Programme Screen
library;
...
class _AEOScreenState extends State<AEOScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for AEO Programme
      // final data = await ApiService().getAEO();
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("AEO Programme", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
