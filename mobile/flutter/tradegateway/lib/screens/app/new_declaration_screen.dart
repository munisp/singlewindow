/// TradeGateway™ NGSWTP — Flutter New Declaration Screen
library;
...
class _NewDeclarationScreenState extends State<NewDeclarationScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for New Declaration
      // final data = await ApiService().getNewDeclaration();
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("New Declaration", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
