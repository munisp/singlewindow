/// TradeGateway™ NGSWTP — Flutter Cargo Tracking Screen
library;
...
class _CargoTrackingScreenState extends State<CargoTrackingScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      // TODO: Call specific ApiService method for Cargo Tracking
      // final data = await ApiService().getCargoTracking();
          ...
          : _error != null
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text("Cargo Tracking", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 16),
                      Container(
                        padding: const EdgeInsets.all(16),
